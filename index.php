...
?>
    ...
    <section class="section section--ink">
      <div class="shell split split--flip">
        <div class="split__media reveal">
          <img src="assets/images/oba-portrait.jpg" alt="Portrait honouring the throne of the Oba of Benin"
            loading="lazy">
        </div>
        <div class="split__body reveal" data-d="1">
...
<?php foreach ($latestNews as $i => $post): ?>
          <article class="card reveal"<?php echo $i > 0 ? ' data-d="' . $i . '"' : ''; ?>><span class="card__num"><?php echo e($post['category'] ?: 'Palace News'); ?> &middot; <?php echo e(format_date($post['published_at'])); ?></span>
...
<?php if (empty($previewGallery)): ?>
          <a class="mcard reveal" href="gallery.php"><img src="assets/images/throne-room.jpg"
              alt="The royal throne room" loading="lazy">
...
<?php foreach ($previewGallery as $i => $img): ?>
          <a class="mcard reveal"<?php echo $i > 0 ? ' data-d="' . $i . '"' : ''; ?> href="gallery.php"><img src="<?php echo e(UPLOADS_GALLERY_URL . '/' . $img['image']); ?>"
